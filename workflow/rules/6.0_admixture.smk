...
rule ngsAdmix:
    ...
    benchmark:
        "benchmarks/{dataset}/ngsadmix/{dataset}.{ref}_all{dp}_K{kvalue}.log"
    container:
        angsd_container
    params:
...
rule plot_admix:
    ...
    benchmark:
        "benchmarks/{dataset}/ngsadmix/{dataset}.{ref}_all{dp}_K{kvalue}_plot.log"
    conda:
        "../envs/r.yaml"
    script:
...
rule evalAdmix:
    ...
    benchmark:
        "benchmarks/{dataset}/evaladmix/{dataset}.{ref}_all{dp}_K{kvalue}.log"
    container:
        evaladmix_container
    shell:
        """
...
rule plot_evalAdmix:
    ...
    benchmark:
        "benchmarks/{dataset}/evaladmix/{dataset}.{ref}_all{dp}_K{kvalue}_plot.log"
    container:
        evaladmix_container
    script:

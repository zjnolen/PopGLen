...
rule ngsAdmix:
    ...
    output:
        qopt="results/datasets/{dataset}/analyses/ngsadmix/{dataset}.{ref}_all{dp}_{sites}-filts_K{kvalue}.qopt",
        fopt="results/datasets/{dataset}/analyses/ngsadmix/{dataset}.{ref}_all{dp}_{sites}-filts_K{kvalue}.fopt.gz",
        log="results/datasets/{dataset}/analyses/ngsadmix/{dataset}.{ref}_all{dp}_{sites}-filts_K{kvalue}_optimization_wrapper.log",
    log:
        "logs/{dataset}/ngsadmix/{dataset}.{ref}_all{dp}_{sites}-filts_K{kvalue}.log",
    benchmark:
        "benchmarks/{dataset}/ngsadmix/{dataset}.{ref}_all{dp}_{sites}-filts_K{kvalue}.log"
    container:
        angsd_container
    params:
...
rule plot_admix:
    ...
    """
    input:
        "results/datasets/{dataset}/analyses/ngsadmix/{dataset}.{ref}_all{dp}_{sites}-filts_K{kvalue}.qopt",
    ...
    benchmark:
        "benchmarks/{dataset}/ngsadmix/{dataset}.{ref}_all{dp}_{sites}-filts_K{kvalue}_plot.log"
    conda:
        "../envs/r.yaml"
    script:
...
rule evalAdmix:
    ...
    input:
        ...
        fopt="results/datasets/{dataset}/analyses/ngsadmix/{dataset}.{ref}_all{dp}_{sites}-filts_K{kvalue}.fopt.gz",
    output:
        "results/datasets/{dataset}/analyses/ngsadmix/{dataset}.{ref}_all{dp}_{sites}-filts_K{kvalue}.corres",
    log:
        "logs/{dataset}/evaladmix/{dataset}.{ref}_all{dp}_{sites}-filts_K{kvalue}.log",
    benchmark:
        "benchmarks/{dataset}/evaladmix/{dataset}.{ref}_all{dp}_{sites}-filts_K{kvalue}.log"
    container:
        evaladmix_container
    shell:
        """
...
rule plot_evalAdmix:
    ...
    """
    input:
        corres="results/datasets/{dataset}/analyses/ngsadmix/{dataset}.{ref}_all{dp}_{sites}-filts_K{kvalue}.corres",
        qopt="results/datasets/{dataset}/analyses/ngsadmix/{dataset}.{ref}_all{dp}_{sites}-filts_K{kvalue}.qopt",
    ...
    benchmark:
        "benchmarks/{dataset}/evaladmix/{dataset}.{ref}_all{dp}_{sites}-filts_K{kvalue}_plot.log"
    container:
        evaladmix_container
    script:

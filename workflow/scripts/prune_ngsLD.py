...
parser.add_argument("--output", help="The file to output pruned SNPs to.", default=sys.stdout)
...
print("Filtering edges from graph...", file=sys.stderr)
...
print("Dropping neighbors from heaviest vertices...", file=sys.stderr)
while True:
	edges = G.num_edges()
	if edges == 0:
		break
	...
	print(max_weight, file=sys.stderr)
...
print("Exporting kept sites to file...", file=sys.stderr)
...
print(datetime.datetime.now() - begin_time, file=sys.stderr)